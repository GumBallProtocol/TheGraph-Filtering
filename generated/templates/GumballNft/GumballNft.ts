...
export class GumballNft extends ethereum.SmartContract {
  ...
  gumballIndex(param0: BigInt): BigInt {
    let result = super.call("gumballIndex", "gumballIndex(uint256):(int256)", [
  ...
  try_gumballIndex(param0: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "gumballIndex",
      "gumballIndex(uint256):(int256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  gumballsLength(): BigInt {
    let result = super.call("gumballsLength", "gumballsLength():(uint256)", []);

    return result[0].toBigInt();
  }

  try_gumballsLength(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "gumballsLength",
      "gumballsLength():(uint256)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
